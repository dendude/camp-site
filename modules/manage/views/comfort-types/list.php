...
$action = \app\modules\manage\controllers\ComfortTypesController::LIST_NAME;
$this->title = $action;
        ...
        echo GridView::widget([
            ...
            'columns' => [
                ...
                [
                    ...
                    'format' => 'html',
                    'value' => function(\app\models\ComfortTypes $model){
                        return Html::img("/img/comfort/{$model->icon}", ['width' => 36]);
                    },
                ],
                [
                    'attribute' => 'title',
