...
$action = $model->id ? 'Редактирование страны' : 'Добавление страны';
$this->title = $action;
$this->params['breadcrumbs'] = [
    ['label' => LocCountriesController::LIST_NAME, 'url' => ['list']],
    ['label' => $action]
];
...
<div class="max-width-1000">
    ...
    <div class="box box-primary">
        ...
        <div class="box-body">
            ...
            <?= $form->field($model, 'name_in')->textInput(['placeholder' => 'Пример: в России']) ?>
